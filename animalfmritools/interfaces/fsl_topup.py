...
class TOPUPInputSpec(FSLCommandInputSpec):
    ...
    config = traits.String('b02b0.cnf', argstr='--config=%s', usedefault=True,
                           desc=('Name of config file specifying command line '
                                 'arguments'))
    dfout = traits.String('warpfield', argstr='--dfout=%s', usedefault=True,desc=('outputname for warpfields'))
    rbmout = traits.String('xfm', argstr='--rbmout=%s', usedefault=True,desc=('outputname for affine transformation'))
